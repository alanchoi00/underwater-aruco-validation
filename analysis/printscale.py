"""Stage 3b: recover the print scale from A4 sheet geometry.

The physical board is gone, so a ruler is impossible. But a printer scales CONTENT,
not paper: A4 is 210x297 mm by definition. So measuring a sheet in units where the
marker is assumed 155.64 mm gives the print scale directly, and it divides out of
every range.
